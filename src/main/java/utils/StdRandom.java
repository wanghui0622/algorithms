...
public final class StdRandom {
    ...
    private static long seed;       //生成随机数种子
     ...
     * pseudo-random生成器
     *
     * 本方法保证多次调用该方法时，每次执行产生相同的“随机”数字序列。
     *
     * @param s the seed
     */
    ...
    /**
     * 从一个几何分布中返回一个随机整数，其成功概率p。整数表示第一次成功之前独立试验的次数。
     *
